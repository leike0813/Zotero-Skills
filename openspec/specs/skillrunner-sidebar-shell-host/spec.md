# skillrunner-sidebar-shell-host Specification

## Purpose
TBD - created by archiving change migrate-skillrunner-run-workspace-to-right-sidebar-shell. Update Purpose after archive.
## Requirements
