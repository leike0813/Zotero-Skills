...
describe("workflow: mineru", function () {
  ...
  it("does not filter when only Images_<itemKey> directory exists", async function () {
    const workflow = await getMineruWorkflow();
  ...
  it("filters conflicting input when attachment uses attachments: relative path form", async function () {
    const workflow = await getMineruWorkflow();
  ...
  it("filters conflicting input when attachment path prefix is singular attachment:", async function () {
    const workflow = await getMineruWorkflow();
  ...
  it("filters conflicting input when pathToFile rejects drive paths with forward slashes", async function () {
    const workflow = await getMineruWorkflow();
  ...
  it("replaces existing orphan images directory before moving new images", async function () {
    const workflow = await getMineruWorkflow();
  ...
  it("fails when full.md is missing and does not create partial outputs", async function () {
    const workflow = await getMineruWorkflow();
