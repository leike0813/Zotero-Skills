...
- **优点**：通过官方 OAuth 登录可**每天免费调用 1000 次 Qwen3.6-Plus** — 目前最慷慨的免费额度之一。文献任务表现优秀。
- **缺点**：需要阿里云账户进行 OAuth 认证。
- **结论**：**免费党首选**，无需付费即可获得高额度调用。
...
- **通知**：**iFlow-CLI 将于 2026 年 4 月 17 日停运**。不再建议新部署。
- **优点**：完全免费（服务停运前）。
